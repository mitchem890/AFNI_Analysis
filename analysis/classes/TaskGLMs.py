...
class TaskGLMs(object):
    def __init__(self, working_dir, images: image_list):
        ...
        self.buttonPress_model = "'TENTzero(0,16.8,16)'"
        self.button_idx = "0..13"
        self.blockONandOFF_model = "'TENTzero(0,16.8,16)'"
...
class AxcptGLMs(TaskGLMs):
    def __init__(self, working_dir, images: image_list):
        ...
        self.event_model = "'TENTzero(0,21.6,20)'"
        self.idx = "0..17"
        self.glms = []
...
class CuedtsGLMs(TaskGLMs):
    def __init__(self, working_dir, images: image_list):
        TaskGLMs.__init__(self, working_dir, images)
        self.event_model = "'TENTzero(0,24,22)'"
        self.idx = "0..19"
        self.glms = []
        self.glms.append(self.create_on_blocks_glms())
        self.glms.append(self.create_on_mixed_glms())
...
class SternGLMs(TaskGLMs):
    def __init__(self, working_dir, images: image_list):
        TaskGLMs.__init__(self, working_dir, images)
        self.event_model = "'TENTzero(0,26.4,24)'"
        self.idx = "0..21"
        self.glms = []
        self.glms.append(self.create_on_blocks_glms())
        self.glms.append(self.create_on_mixed_glms())
...
class StroopGLMs(TaskGLMs):
    def __init__(self, working_dir, images: image_list):
        TaskGLMs.__init__(self, working_dir, images)
        self.event_model = "'TENTzero(0,16.8,16)'"
        self.idx = "0..13"
